...
export default class Recommendation extends Component {
    ...
    return (
          ...
          <List>
            <ListItem style={{}}>
              <Thumbnail  size={20} source={stores.config.Spire} />
              <Body>
                <Text>Spire</Text>
            ...
            <ListItem>
            <Thumbnail size={20} source={stores.config.Temple} />
              <Body>
            ...
            <ListItem>
            <Thumbnail  size={20} source={stores.config.HalfPenny} />
              <Body>
            ...
            <ListItem>
            <Thumbnail  size={20} source={stores.config.Library} />
              <Body>
            ...
            <ListItem>
            <Thumbnail  size={20} source={stores.config.DubCastle} />
              <Body>
